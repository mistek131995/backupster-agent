...
public sealed class S3UploadProvider : IUploadProvider, IDisposable
{
    private readonly S3Settings _settings;
    private readonly ILogger<S3UploadProvider> _logger;
    private AmazonS3Client? _client;

    public S3UploadProvider(S3Settings settings, ILogger<S3UploadProvider> logger)
    {
        _settings = settings;
        _logger = logger;
