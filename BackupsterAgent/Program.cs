...
builder.Services.AddSingleton<MssqlPhysicalDifferentialBackupProvider>();
...
builder.Services.AddSingleton<RestorePathResolver>();
builder.Services.AddSingleton<RestoreMarkerStore>();
builder.Services.AddSingleton<FilesystemRenamePreflight>();
builder.Services.AddSingleton<LinuxProcessInspector>();
builder.Services.AddSingleton<SystemdUnitDetector>();
builder.Services.AddSingleton<SystemdServiceController>();
